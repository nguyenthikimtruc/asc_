...
def save_model(filename,model):
    """Save model to json-file and save model_weights to h5-file
    ...
    filename: str
        Path to file
    models: dict
        Dict containing structure of model to be saved
        or Dict containing weights of model 
    ...
    keras_model_filename = os.path.splitext(filename)[0] + '.hdf5'
    model_weights_filename = os.path.splitext(filename)[0] + '.weights.hdf5'
    model.save(keras_model_filename)
    model.save_weights(model_weights_filename)
    
def load_model(filename):
    """Load model and model_weights from h5-file
